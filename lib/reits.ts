...
export const REIT_UNIVERSE: REITInfo[] = [
  ...
  { ticker: "DOC",  name: "Healthpeak Properties",        sector: "Healthcare",          website: "https://www.healthpeak.com",           ir: "https://ir.healthpeak.com" },
  ...
  { ticker: "SBRA", name: "Sabra Health Care REIT",       sector: "Healthcare",          website: "https://www.sabrahealth.com",          ir: "https://ir.sabrahealth.com" },
  { ticker: "AHR",  name: "American Healthcare REIT",     sector: "Healthcare",          website: "https://www.americanhealthcarereit.com", ir: "https://ir.americanhealthcarereit.com" },
  { ticker: "CTRE", name: "CareTrust REIT",               sector: "Healthcare",          website: "https://www.caretrustREIT.com",        ir: "https://ir.caretrustREIT.com" },
  { ticker: "ARE",  name: "Alexandria Real Estate Equities", sector: "Healthcare",       website: "https://www.are.com",                  ir: "https://ir.are.com" },
  { ticker: "HR",   name: "Healthcare Realty Trust",      sector: "Healthcare",          website: "https://www.healthcarerealty.com",     ir: "https://investors.healthcarerealty.com" },
  { ticker: "NHI",  name: "National Health Investors",    sector: "Healthcare",          website: "https://www.nhireit.com",              ir: "https://ir.nhireit.com" },
  { ticker: "LTC",  name: "LTC Properties",               sector: "Healthcare",          website: "https://www.ltcreit.com",              ir: "https://ir.ltcreit.com" },
  { ticker: "DHC",  name: "Diversified Healthcare Trust", sector: "Healthcare",          website: "https://www.dhcreit.com",              ir: "https://www.dhcreit.com/investor-relations" },
  { ticker: "NHP",  name: "National Healthcare Properties", sector: "Healthcare" },
  { ticker: "JAN",  name: "Janus Living",                 sector: "Healthcare" },
  { ticker: "XRN",  name: "Chiron",                       sector: "Healthcare" },
  { ticker: "SNDA", name: "Sonida Senior Living",         sector: "Healthcare",          website: "https://www.sonidaseniorliving.com",   ir: "https://ir.sonidaseniorliving.com" },
  { ticker: "SIA",  name: "Sienna Senior Living",         sector: "Healthcare" },
  // Self Storage
